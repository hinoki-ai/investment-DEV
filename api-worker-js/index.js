// Cloudflare Worker API for Investment Dashboard
...
export default {
  async fetch(request, env, ctx) {
    ...
    if (path === "/api/v1/investments" && method === "GET") {
      return new Response(JSON.stringify({
        items: [
          { id: "1", name: "Beach House", category: "real_estate", value: 150000 },
          { id: "2", name: "Apple Stock", category: "stocks", value: 50000 },
          { id: "3", name: "Gold Coins", category: "gold", value: 50000 }
        ],
        total: 3
      }), { headers: corsHeaders });
    }
